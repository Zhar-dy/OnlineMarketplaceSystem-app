...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Create an Order for {{$product->}}</div>
                ...
                <div class="card-body">
                    {{-- <form method="POST" action="{{ route('category.product.store', $category) }}"> --}}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" value="{{$product}}" placeholder="Product Name" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label"> Quantity product</label>
