            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <select name="status" class="form-select" aria-label="Default select example">
                        ...
                        <option value="shipped" @selected($order->status == 'pending')>{{ __('Shipped') }}</option>
                        <option value="delivered" @selected($order->status == 'pending')>{{ __('Delivered') }}</option>
                        <option value="canceled" @selected($order->status == 'pending')>{{ __('Cancel') }}</option>
                    </select>
                </div>
