        ...
        <form action="{{ route('category.update',$order) }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label fw-bold">Total Amount:</label>
                        <input type="text" class="form-control" name="name" id="recipient-name" value="{{$category->total_amount}}" required>
                    </div>
                    <div class="mb-3">
