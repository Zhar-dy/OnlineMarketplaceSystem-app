        ...
        <form action="{{ route('payment.store') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="message-text" class="col-form-label fw-bold">Payment Status:</label>
                        <input type="text" class="form-control" value="pending" name="paymentstatus" required readonly>
                    </div>
                </div>
