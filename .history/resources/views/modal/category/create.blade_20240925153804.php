...
<div class="modal fade" id="lessonModal-{{ $course->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <form action="{{ route('lesson.store', $course) }}" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">Create Lesson</h1>
